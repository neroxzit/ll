...
If there are any vulnerabilities in **Nightosphere**, don't hesitate to _report them_.

1. Use any of the [private contact addresses](https://github.com/TeamStetch/Nightosphere#support).
