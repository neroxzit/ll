...
from Stetchfy import settingsApp
from strings import get_command
...
async def musicme(client, message):
       ...
       if message.chat.id not in disable:
         ...
         url = f"https://t.me/stetchfy/{rl}"
         await message.reply_voice(url,caption="-› [• 𝒑𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝒔𝒕𝒆𝒕𝒄𝒉𝒇𝒚 •](t.me/stetchfy)")
...
async def ava(client, message):
       ...
       if message.chat.id not in disable_A:
         ...
         url = f"https://t.me/stetchfy/{rl}"
         await message.reply_photo(url,caption="-› [• 𝒑𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝒔𝒕𝒆𝒕𝒄𝒉𝒇𝒚 •](t.me/stetchfy)")
...
async def qw2(client,message):
       ...
       if message.chat.id not in disable_G:
         ...
         url = requests.get(f"https://t.me/stetchfy/{rl}").text
