#
# Copyright (C)  2021-2024 by TeamKillerX@Github, < https://github.com/TeamKillerX >.
#
# This file is part of < https://github.com/TeamKillerX/StetchfyBot > project,
# and is released under the "GNU v3.0 License Agreement".
# Please see < https://github.com/TeamKillerX/StetchfyBot/blob/master/LICENSE >
#
# All rights reserved.
...
from Stetchfy.utils.database import get_lang, set_lang
from Stetchfy.utils.decorators import (ActualAdminCB, language,
                                         languageCB)
...
def lanuages_keyboard(_):
    ...
    keyboard.row(
        InlineKeyboardButton(
            text="🇪🇬 العربية", callback_data="languages:ar"
       ),
    )
    keyboard.row(
        InlineKeyboardButton(
