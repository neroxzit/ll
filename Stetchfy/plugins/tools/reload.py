...
from Stetchfy.utils.database import get_authuser_names, get_cmode
from Stetchfy.utils.decorators import ActualAdminCB, AdminActual, language
from Stetchfy.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Stetch.stop_stream(message.chat.id)
    except:
        pass
