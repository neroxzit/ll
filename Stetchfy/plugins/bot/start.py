...
from Stetchfy import Telegram, YouTube, app
from Stetchfy.misc import SUDOERS
from Stetchfy.plugins.play.playlist import del_plist_msg
from Stetchfy.plugins.sudo.sudoers import sudoers_list
...
from Stetchfy.utils.decorators.language import LanguageStart
from Stetchfy.utils.inline import help_pannel, private_panel, start_pannel
from Stetchfy.utils.command import commandpro
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/TXNX5) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
@app.on_message(commandpro(["/alive", "Stetch"]) & ~filters.edited)
...
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 sʜɪᴢᴜᴋᴀ ᴄʜᴀᴛ 💮", url=f"https://t.me/TXNX5")]]
        ),
    )
