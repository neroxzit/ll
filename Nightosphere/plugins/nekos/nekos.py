...
def slap(_, m: Message):
    reply = m.reply_to_message
    if reply:
        url = ("https://telegra.ph/file/8c3cc53ab3bdd991553a9.mp4")
        name1 = reply.from_user.mention
        name2 = m.from_user.mention
        reply.reply_animation(url, caption="قام ↫{}\n بضرب الغلبان ↫ {} على وشه\n الصراحة يستاهل 😂".format(name2, name1))
    else:
        url = ("https://telegra.ph/file/8c3cc53ab3bdd991553a9.mp4")
        m.reply_animation(url, caption=f"**يا ترا يا ** {m.from_user.mention} ناوي تدي مين القلم الحلو ده")
