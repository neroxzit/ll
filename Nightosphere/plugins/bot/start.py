...
from Nightosphere.misc import SUDOERS, _boot_
...
from Nightosphere.utils.formatters import get_readable_time
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[قناة السورس](https://t.me/NightosphereVIP) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• قناة السورس •", url="https://t.me/NightosphereVIP"
                        ),
                    ],
                ]
            )
