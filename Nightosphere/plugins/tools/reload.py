...
from Nightosphere.utils.decorators import (ActualAdminCB, AdminActual,
                                        language)
from Nightosphere.utils.formatters import alpha_to_int
...
async def restartbot(_client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await NightoX.stop_stream(message.chat.id)
    except:
        pass
