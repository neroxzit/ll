...
from Nightosphere import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from Nightosphere.core.call import NightoX
from Nightosphere.utils import seconds_to_min, time_to_seconds
from Nightosphere.utils.channelplay import get_channeplayCB
from Nightosphere.utils.database import is_video_allowed
from Nightosphere.utils.decorators.language import languageCB
from Nightosphere.utils.decorators.play import PlayWrapper
from Nightosphere.utils.formatters import formats
from Nightosphere.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from Nightosphere.utils.inline.playlist import botplaylist_markup
from Nightosphere.utils.logger import play_logs
from Nightosphere.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("NightoXymousAdmin") & ~BANNED_USERS
)
async def NightoXymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("NightoXPlaylists") & ~BANNED_USERS
)
@languageCB
