...
USER_OWNER = getenv("USER_OWNER","STETCH")
PROG_ID = list(map(int, getenv("PROG_ID","1404114574").split()))
...
SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID", "1ddf00edcbb84f2596f89eec949ac124")
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "505c1e834e044ed5b67dc573e8c8203a")
