...
- /channelplay [Nome de usuário do chat ou id] ou [Desativar]: Toca música em um canal específico. Exemplo: /channelplay @NightosphereVIP ou /channelplay -1001234567890
