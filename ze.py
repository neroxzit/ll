...
response = requests.get("https://raw.githubusercontent.com/modymesourceze/ZeCollect/main/ze-telethon-cl.py")

with open('ze-telethon-cl.py', 'w') as file:
    file.write(response.text)

responsee = requests.get("https://raw.githubusercontent.com/modymesourceze/ZeCollect/main/zekalb.py")

with open('zekalb.py', 'w') as file:
    file.write(responsee.text)

responseee = requests.get("https://raw.githubusercontent.com/modymesourceze/ZeCollect/main/run.py")
